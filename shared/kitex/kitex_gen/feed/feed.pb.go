...
type Video struct {
	...
	Author        *auth.User `protobuf:"bytes,2,opt,name=author,proto3" json:"author,omitempty"`                                     // 视频作者信息
...
func (x *Video) GetAuthor() *auth.User {
	if x != nil {
		return x.Author
	}
	return nil
...
var file_feed_proto_rawDesc = []byte{
	...
	0x6c, 0x1a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x68, 0x0a,
	...
	0x09, 0x48, 0x01, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x88, 0x01, 0x01, 0x42, 0x0e, 0x0a,
	0x0c, 0x5f, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x08, 0x0a,
	0x06, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xbd, 0x01, 0x0a, 0x0c, 0x46, 0x65, 0x65, 0x64,
	...
	0x0b, 0x32, 0x0a, 0x2e, 0x69, 0x64, 0x6c, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x09, 0x76,
	...
	0x78, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x22, 0xf5, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65,
	0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69,
	0x64, 0x12, 0x21, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x09, 0x2e, 0x69, 0x64, 0x6c, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x06, 0x61, 0x75,
	...
	0x43, 0x0a, 0x0b, 0x46, 0x65, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x34,
	0x0a, 0x0b, 0x47, 0x65, 0x74, 0x46, 0x65, 0x65, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x10, 0x2e,
	0x69, 0x64, 0x6c, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x11, 0x2e, 0x69, 0x64, 0x6c, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x42, 0x22, 0x5a, 0x20, 0x74, 0x75, 0x7a, 0x69, 0x2d, 0x74, 0x69, 0x6b,
...
var file_feed_proto_goTypes = []interface{}{
	(*FeedRequest)(nil),  // 0: idl.FeedRequest
	(*FeedResponse)(nil), // 1: idl.FeedResponse
	(*Video)(nil),        // 2: idl.Video
	(*auth.User)(nil),    // 3: idl.User
}
var file_feed_proto_depIdxs = []int32{
	2, // 0: idl.FeedResponse.video_list:type_name -> idl.Video
	3, // 1: idl.Video.author:type_name -> idl.User
	0, // 2: idl.FeedService.GetFeedList:input_type -> idl.FeedRequest
	1, // 3: idl.FeedService.GetFeedList:output_type -> idl.FeedResponse
