...
func serviceInfo() *kitex.ServiceInfo {
	return authInfoServiceServiceInfo
}

var authInfoServiceServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "AuthInfoService"
	handlerType := (*auth.AuthInfoService)(nil)
...
func loginHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(auth.AuthInfoService).Login(ctx, req)
		if err != nil {
			return err
		}
	...
	case *LoginArgs:
		success, err := handler.(auth.AuthInfoService).Login(ctx, s.Req)
		if err != nil {
			return err
		}
...
var LoginResult_Success_DEFAULT *auth.UserRegisterResponse
...
func (p *LoginResult) GetSuccess() *auth.UserRegisterResponse {
	if !p.IsSetSuccess() {
...
func registerHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(auth.AuthInfoService).Register(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *RegisterArgs:
		success, err := handler.(auth.AuthInfoService).Register(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getUserInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(auth.UserInfoRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(auth.AuthInfoService).GetUserInfo(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetUserInfoArgs:
		success, err := handler.(auth.AuthInfoService).GetUserInfo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *GetUserInfoArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(auth.UserInfoRequest)
	}
	return p.Req.FastRead(buf, _type, number)
}
...
var GetUserInfoArgs_Req_DEFAULT *auth.UserInfoRequest

func (p *GetUserInfoArgs) GetReq() *auth.UserInfoRequest {
	if !p.IsSetReq() {
...
type GetUserInfoResult struct {
	Success *auth.UserInfoResponse
}

var GetUserInfoResult_Success_DEFAULT *auth.UserInfoResponse

func (p *GetUserInfoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(auth.UserInfoResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *GetUserInfoResult) GetSuccess() *auth.UserInfoResponse {
	if !p.IsSetSuccess() {
...
func (p *GetUserInfoResult) SetSuccess(x interface{}) {
	p.Success = x.(*auth.UserInfoResponse)
}
...
func (p *kClient) Login(ctx context.Context, Req *auth.UserLoginRequest) (r *auth.UserRegisterResponse, err error) {
	var _args LoginArgs
	_args.Req = Req
...
func (p *kClient) GetUserInfo(ctx context.Context, Req *auth.UserInfoRequest) (r *auth.UserInfoResponse, err error) {
