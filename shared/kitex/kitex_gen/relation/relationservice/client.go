...
type Client interface {
	FollowAction(ctx context.Context, Req *relation.RelationRequest, callOptions ...callopt.Option) (r *relation.RelationResponse, err error)
...
func (p *kRelationServiceClient) FollowAction(ctx context.Context, Req *relation.RelationRequest, callOptions ...callopt.Option) (r *relation.RelationResponse, err error) {
